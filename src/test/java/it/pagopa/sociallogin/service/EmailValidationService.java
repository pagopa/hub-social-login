...
//				.replace("]", "")
//				.replace(",","|");
//		Pattern VALID_EMAIL_DOMAIN_REGEX = Pattern.compile(allowedDomainsString, Pattern.CASE_INSENSITIVE);
//		Matcher matcher = VALID_EMAIL_DOMAIN_REGEX.matcher(emailStr);
//		if (!matcher.find())
//			throw new DomainNotAllowedException("domain not allowed");
//		
//	}
//	public void isAllowedFromOauth2Token(OAuth2AuthenticationToken oauth2AuthenticationToken) throws DomainNotAllowedException {
