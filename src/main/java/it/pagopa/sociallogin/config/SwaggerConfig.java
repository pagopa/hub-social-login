    ...
    public Docket swaggerSpringPlugin(@Autowired TypeResolver typeResolver) {
        return (new Docket(DocumentationType.OAS_30))
                .apiInfo(new ApiInfoBuilder()
                        ...
                        .build())
                .select().apis(RequestHandlerSelectors.basePackage("it.pagopa.selfcare.selclogin.controller")).build()
                .tags(new Tag("login", environment.getProperty("swagger.login.api.description")))
